...
android {
    ...
    defaultConfig {
        ...
        // Load 3 actual keys from local.properties
        val hereApiKey = localProperties.getProperty("here_api_key") ?: ""
        val googleMapsApiKey = localProperties.getProperty("google_maps_api_key") ?: ""
        val geminiApiKey = localProperties.getProperty("gemini_api_key") ?: ""
        
        // Map to 5 BuildConfig fields (HERE and Google each use same key for multiple services)
        buildConfigField("String", "HERE_API_KEY", "\"${hereApiKey}\"")
        buildConfigField("String", "HERE_MAP_KEY", "\"${hereApiKey}\"")
        buildConfigField("String", "GOOGLE_MAPS_API_KEY", "\"${googleMapsApiKey}\"")
        buildConfigField("String", "GOOGLE_PLACES_API_KEY", "\"${googleMapsApiKey}\"")
...
dependencies {
    ...
    // Navigation Fragment (for XML-based navigation)
